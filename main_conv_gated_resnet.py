...
parser.add_argument('--ngf_gate', type=int, default=128)
...
parser.add_argument('--outf', default='./conv_gated_resnet_gen/', help='folder to output images and model checkpoints')
